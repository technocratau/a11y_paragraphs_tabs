...
(function (jQuery, Drupal) {
    ...
    function AccordionTabs (el, options) {
        ...
        this.el = el;
        this.tabTriggers = this.el.children[0].getElementsByClassName('js-tabs-trigger');
        this.tabPanels = this.el.children[1].children;
    ...
    Drupal.behaviors.a11yParagraphsTabs = {
        attach: function (context, settings) {
            jQuery(".js-tabs", context).once().each(function (key, input) {
